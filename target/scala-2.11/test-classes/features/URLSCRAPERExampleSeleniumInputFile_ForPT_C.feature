...
Feature: Feature Number 2 ExampleSeleniumInputFile_ForPT_C
  ...
  Scenario: Scenario Number 1
    ...
    And Business accounting period where 'fieldStartDateDateDay' is '01' and 'fieldStartDateDateMonth' is '01' and 'fieldStartDateDateYear' is '2019' and 'fieldEndDateDateDay' is '01' and 'fieldEndDateDateMonth' is '01' and 'fieldEndDateDateYear' is '2020' and select 'clickContinueButton'
    And Business name where 'fieldBusinessName' is 'Third Flow' and select 'clickContinueButton'
