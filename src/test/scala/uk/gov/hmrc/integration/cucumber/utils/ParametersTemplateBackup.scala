...
object ParametersTemplateBackup {
...
//        path = "https://preview.tax.service.gov.uk"
  ...
  def getParam(paramName: String): String = {
    val returnUrl: String = paramName match {
      ...
      case "clickSignOutButton"                                                                     => "sign-out-button"
      case "clickSignin"                                                                            => "signin"
      case "clickSpanSummary"                                                                       => "span.summary"
      case "clickStartButton"                                                                       => "start-button"
      case "urlAccountingMethod"                                                                    => ""
      case "urlAuthLoginStub"                                                                       => authUrl + "/auth-login-stub/gg-sign-in"
      case "urlBusinessAccountingPeriod"                                                            => ""
      case "urlBusinessName"                                                                        => ""
      case "urlCheckYourAnswers"                                                                    => ""
      case "urlClientMatchError"                                                                    => ""
      case "urlConfirmYourClient"                                                                   => ""
      case "urlDoYouHaveAnyOtherSourcesOfIncome"                                                    => ""
      case "urlDoesYourClientHaveAnyOtherSourcesOfIncome"                                           => ""
      case "urlEnterYourClientsDetails"                                                             => ""
      case "urlIncomeAndExpenses"                                                                   => "http://localhost:9561/report-quarterly/income-and-expenses/sign-up"
      case "urlSelectYourClientsIncomeType"                                                         => ""
      case "urlSignInGovernmentGateway"                                                             => ""
      case "urlTermsOfParticipation"                                                                => ""
      case "urlWhereDoesYourIncomeComeFrom"                                                         => ""
      case "urlYouCanOnlySendQuarterlyReportsOnPartOfYourClientsIncome"                             => ""
      case "urlYouCanOnlySendQuarterlyReportsOnPartOfYourIncome"                                    => ""
      case "urlYouCantSendQuarterlyReportsYet"                                                      => ""
      case "urlYouCantSignUpForQuarterlyReportingYet"                                               => ""
