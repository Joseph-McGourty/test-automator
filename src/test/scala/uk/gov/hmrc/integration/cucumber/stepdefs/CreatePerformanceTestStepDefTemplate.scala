...
//    copyFileToFile(PToutputFilePath, PTjourneyConf, PTjourneyConfDir, "journeys.conf")
    copyFileToFile(PToutputFilePath, PTjourneyConf, PTjourneyConfDir, "journeys1.conf")
...
//  BasePageTemplate.driver.close
  ...
  When("""^a URL_SCRAPE_LIST is read the performance test Url variables are updated$""") {
